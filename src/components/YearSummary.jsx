...
export default function YearSummary({ yearly }) {
  ...
  return (
    <div className="year-summary">
      ...
      <span className="summary-item credit">{avg(yearly.totalStructuralIncome)} structureel</span>
      {yearly.totalOneOffIncome > 0 && (
        <span className="summary-item credit" style={{ opacity: 0.65 }}>{avg(yearly.totalOneOffIncome)} eenmalig</span>
      )}
      <span className="summary-item debit">{avg(yearly.totalRecurring)} vaste lasten</span>
      <span className="summary-item debit" style={{ opacity: 0.65 }}>{avg(yearly.totalOneOff)} eenmalig</span>
